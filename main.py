...
st.image("https://github.com/AMIROLIMI/Data_Science_fanalproj_module1/blob/main/CORR_before.png", caption="Описание изображения", use_column_width=True)
...
st.image("https://github.com/AMIROLIMI/Data_Science_fanalproj_module1/blob/main/CORR_after.png", caption="Описание изображения", use_column_width=True)
